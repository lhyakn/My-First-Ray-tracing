...
class xy_rect: public hittable {
    public:
        ...
        virtual aabb bounding_box() const {
            aabb output_box =  aabb(vec3(x0,y0, k-0.0001), vec3(x1, y1, k+0.0001));
            return output_box;
        }
...
class xz_rect: public hittable {
    public:
        ...
        virtual aabb bounding_box() const {
            aabb output_box =  aabb(vec3(x0,k-0.0001,z0), vec3(x1, k+0.0001, z1));
            return output_box;
        }
...
class yz_rect: public hittable {
    public:
        ...
        virtual aabb bounding_box() const {
            aabb output_box =  aabb(vec3(k-0.0001, y0, z0), vec3(k+0.0001, y1, z1));
            return output_box;
        }
